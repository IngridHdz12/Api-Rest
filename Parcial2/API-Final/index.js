...
app.delete('/empleado/:id', (req, res) => {
    const índice = empleados.findIndex(e => e.id === parseInt(req.params.id));
    if (índice === -1) return res.status(404).json({ Error: "Empleado no encontrado" });

    empleados.splice(índice, 1);
